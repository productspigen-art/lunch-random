(() => {
  ...
  const DEFAULT_ITEMS = [
    // 한식/분식/국물
    { name: '김치찌개', cat: 'korean' },
    { name: '된장찌개', cat: 'korean' },
    { name: '순두부찌개', cat: 'korean' },
    { name: '부대찌개', cat: 'korean' },
    { name: '감자탕', cat: 'korean' },
    { name: '해장국', cat: 'korean' },
    { name: '갈비탕', cat: 'korean' },
    { name: '설렁탕', cat: 'korean' },
    ...
    { name: '오뎅탕', cat: 'korean' },
    { name: '불고기', cat: 'korean' },
    { name: '제육볶음', cat: 'korean' },
    { name: '닭갈비', cat: 'korean' },
    { name: '낙지볶음', cat: 'korean' },
    { name: '아구찜', cat: 'korean' },
    { name: '찜닭', cat: 'korean' },
    { name: '삼겹살', cat: 'korean' },
    { name: '갈비', cat: 'korean' },
    { name: '쌈밥', cat: 'korean' },
    { name: '비빔밥', cat: 'korean' },
    { name: '돌솥비빔밥', cat: 'korean' },
    { name: '김밥', cat: 'sandwich' },
    { name: '라면', cat: 'noodle' },
    { name: '냉면', cat: 'noodle' },
    { name: '비빔냉면', cat: 'noodle' },
    { name: '칼국수', cat: 'noodle' },
    { name: '수제비', cat: 'noodle' },
    { name: '잔치국수', cat: 'noodle' },
    { name: '떡볶이', cat: 'noodle' },
    { name: '순대', cat: 'noodle' },
    { name: '오뎅', cat: 'noodle' },
    { name: '파전', cat: 'korean' },
    { name: '감자전', cat: 'korean' },
    { name: '김치전', cat: 'korean' },
    { name: '계란말이', cat: 'korean' },
    { name: '전복죽', cat: 'rice' },

    // 일식
    { name: '초밥', cat: 'japanese' },
    { name: '사시미', cat: 'japanese' },
    { name: '돈까스', cat: 'japanese' },
    { name: '돈카츠', cat: 'japanese' },
    { name: '가츠동', cat: 'japanese' },
    { name: '규동', cat: 'rice' },
    { name: '우동', cat: 'japanese' },
    { name: '라멘', cat: 'japanese' },
    { name: '냉우동', cat: 'japanese' },
    { name: '오므라이스', cat: 'japanese' },
    { name: '가라아게', cat: 'japanese' },
    { name: '야끼소바', cat: 'japanese' },
    { name: '야끼니쿠', cat: 'japanese' },
    { name: '돈부리', cat: 'japanese' },
    { name: '규카츠', cat: 'japanese' },
    { name: '스키야키', cat: 'japanese' },
    { name: '텐동', cat: 'japanese' },
    { name: '가츠카레', cat: 'japanese' },
    { name: '일본카레', cat: 'japanese' },
    { name: '사케동', cat: 'japanese' },
    { name: '미소된장국', cat: 'japanese' },
    { name: '타코야끼', cat: 'japanese' },
    { name: '냉모밀(소바)', cat: 'japanese' },
    { name: '회덮밥', cat: 'japanese' },
    { name: '샤브샤브', cat: 'japanese' },

    // 중식
    { name: '짜장면', cat: 'chinese' },
    { name: '짬뽕', cat: 'chinese' },
    { name: '탕수육', cat: 'chinese' },
    { name: '군만두', cat: 'chinese' },
    { name: '물만두', cat: 'chinese' },
    { name: '마라탕', cat: 'chinese' },
    { name: '마라샹궈', cat: 'chinese' },
    { name: '마라롱샤', cat: 'chinese' },
    { name: '마파두부', cat: 'chinese' },
    { name: '깐풍기', cat: 'chinese' },
    { name: '팔보채', cat: 'chinese' },
    { name: '양장피', cat: 'chinese' },
    { name: '고추잡채', cat: 'chinese' },
    { name: '유산슬', cat: 'chinese' },
    { name: '유린기', cat: 'chinese' },
    { name: '딤섬', cat: 'chinese' },
    { name: '샤오롱바오', cat: 'chinese' },
    { name: '탄탄면', cat: 'chinese' },
    { name: '짜장밥', cat: 'chinese' },
    { name: '잡채밥', cat: 'chinese' },
    { name: '마파두부덮밥', cat: 'chinese' },
    { name: '계란볶음밥', cat: 'chinese' },
    { name: '새우볶음밥', cat: 'chinese' },

    // 양식/브런치/샐러드
    { name: '스테이크', cat: 'western' },
    { name: '함박스테이크', cat: 'western' },
    { name: '피자', cat: 'fast' },
    { name: '파스타', cat: 'western' },
    { name: '리소토', cat: 'western' },
    { name: '리조또', cat: 'western' },
    { name: '감바스', cat: 'western' },
    { name: '샐러드', cat: 'salad' },
    { name: '치즈플래터', cat: 'western' },
    { name: '그라탕', cat: 'western' },
    { name: '그라탱', cat: 'western' },
    { name: '치킨스테이크', cat: 'western' },
    { name: '수프', cat: 'salad' },
    { name: '바게트', cat: 'brunch' },
    { name: '버터롤', cat: 'brunch' },

    // 베트남/태국/동남아
    { name: '쌀국수', cat: 'vietnamese' },
    { name: '분짜', cat: 'vietnamese' },
    { name: '반미', cat: 'vietnamese' },
    { name: '팟타이', cat: 'thai' },
    { name: '나시고렝', cat: 'seasia' },
    { name: '락사', cat: 'seasia' },
    { name: '미고랭', cat: 'seasia' },
    { name: '카오팟', cat: 'thai' },
    { name: '카오만까이', cat: 'thai' },
    ...
    { name: '사테', cat: 'seasia' },
    { name: '바쿠테', cat: 'seasia' },
    { name: '싱가포르치킨라이스', cat: 'seasia' },

    // 인도/네팔
    { name: '인도커리', cat: 'indian' },
    { name: '버터치킨', cat: 'indian' },
    { name: '치킨 티카 마살라', cat: 'indian' },
    { name: '팔락 파니르', cat: 'indian' },
    { name: '탄두리 치킨', cat: 'indian' },
    { name: '비리야니', cat: 'indian' },
    { name: '난 & 커리', cat: 'indian' },
    { name: '로티', cat: 'indian' },

    // 샐러드/랩
    { name: '포케', cat: 'salad' },
    { name: '시저 샐러드', cat: 'salad' },
    { name: '콥 샐러드', cat: 'salad' },
    { name: '연어 샐러드', cat: 'salad' },
    { name: '그릭 샐러드', cat: 'salad' },
    { name: '닭가슴살 샐러드', cat: 'salad' },
    { name: '샐러드랩', cat: 'sandwich' },

    // 샌드위치류/간편식
    { name: '샌드위치', cat: 'sandwich' },
    { name: '클럽 샌드위치', cat: 'sandwich' },
    { name: '파니니', cat: 'sandwich' },
    { name: '베이글 샌드위치', cat: 'sandwich' },
    { name: '토스트', cat: 'sandwich' },
    { name: '핫도그', cat: 'sandwich' },
    { name: '오니기리', cat: 'japanese' },
    { name: '유부초밥', cat: 'japanese' },
    { name: '컵밥', cat: 'rice' },
    ...
    { name: '하이라이스', cat: 'rice' },
    { name: '제육덮밥', cat: 'rice' },
    { name: '치킨마요덮밥', cat: 'rice' },
    { name: '소불고기덮밥', cat: 'rice' },
    { name: '불닭덮밥', cat: 'rice' },
    { name: '스팸마요덮밥', cat: 'rice' },
    { name: '참치마요덮밥', cat: 'rice' },
    { name: '간장계란밥', cat: 'rice' },
    { name: '김치볶음밥', cat: 'rice' },
    { name: '볶음밥', cat: 'rice' },
    { name: '비프볼', cat: 'rice' },
    ...
    // 브런치/지중해
    { name: '에그 베네딕트', cat: 'brunch' },
    { name: '아보카도 토스트', cat: 'brunch' },
    { name: '프렌치 토스트', cat: 'brunch' },
    { name: '팬케이크', cat: 'brunch' },
    { name: '오픈 샌드위치', cat: 'brunch' },
    { name: '그릭 요거트 볼', cat: 'brunch' },
    { name: '케밥', cat: 'med' },
    { name: '팔라펠 플레이트', cat: 'med' },
    { name: '후무스 & 피타', cat: 'med' },
    { name: '샤와르마', cat: 'med' },
    { name: '그릴 랩', cat: 'med' },
    { name: '길로스(기로스)', cat: 'med' },

    // 디저트/음료
    { name: '빙수', cat: 'dessert' },
    { name: '케이크', cat: 'dessert' },
    { name: '쿠키', cat: 'dessert' },
    { name: '마카롱', cat: 'dessert' },
    { name: '크로플', cat: 'dessert' },
    { name: '스콘', cat: 'dessert' },
    { name: '도넛', cat: 'dessert' },
    { name: '와플', cat: 'dessert' },
    { name: '푸딩', cat: 'dessert' },
    { name: '아이스크림', cat: 'dessert' },
    { name: '젤라또', cat: 'dessert' },
    { name: '커피', cat: 'drink' },
    { name: '차', cat: 'drink' },
    { name: '밀크티', cat: 'drink' },
    { name: '스무디', cat: 'drink' },
    ...
    { name: '에이드', cat: 'drink' },
    { name: '버블티', cat: 'drink' },
    { name: '아이스초코', cat: 'drink' },
    { name: '핫초코', cat: 'drink' },

    // 기타/퓨전
    { name: '도시락', cat: 'etc' },
    { name: '죽(전복/쇠고기 등)', cat: 'etc' },
    { name: '카페 런치 세트', cat: 'etc' },
    { name: '불닭파스타', cat: 'western' },
    { name: '치즈돈까츠', cat: 'japanese' },
    { name: '김치필라프', cat: 'rice' },
    { name: '김치파스타', cat: 'western' },
    { name: '크림리조또', cat: 'western' },
    { name: '김치리조또', cat: 'western' },
  ];
  ...
  const state = {
    ...
    context: (()=>{
      ...
      if(Array.isArray(saved.mood) && !Array.isArray(saved.situation)) saved.situation = saved.mood; // migrate
  ...
  // Merge defaults into existing local data
  ...
  function migrateIfNeeded(){
    ...
    if(ver < SCHEMA_VERSION){
      ...
      storage.set('lm_schema_version', SCHEMA_VERSION);
      saveState();
    }
  }
  ...
  function renderCategories(){
    ...
    state.categories.forEach(cat => {
      ...
      const selected = state.selectedCats.has(cat.id);
      b.setAttribute('aria-selected', String(selected));
      b.addEventListener('click', ()=>{
        if(state.selectedCats.has(cat.id)) state.selectedCats.delete(cat.id);
        else state.selectedCats.add(cat.id);
        saveState();
        renderCategories();
      });
  ...
  function renderSeasonal(){
    ...
    const SEASONAL_BY_MONTH = {
      1: ['굴', '과메기', '대구', '미나리', '시금치', '감귤'],
      2: ['광어', '우럭', '굴', '달래', '냉이', '꼬막'],
      3: ['주꾸미', '도다리', '쑥', '달래', '딸기'],
      4: ['주꾸미', '멍게', '참나물', '비빔국수', '봄동'],
      5: ['쭈꾸미', '전어(봄)', '매실', '주키니', '오이'],
      6: ['참치', '병어', '옥수수', '토마토', '블루베리'],
      7: ['민어', '장어', '수박', '참외', '토마토', '옥수수'],
      8: ['전복', '갈치', '복숭아', '포도', '가지'],
      9: ['전어(가을)', '꽃게', '배', '사과', '무화과', '고구마'],
      10: ['대하', '전어', '낙지', '밤', '곶감', '배추'],
      11: ['방어', '굴', '무', '배추', '귤', '단감'],
      12: ['방어', '꼬막', '굴', '대구', '시금치', '감귤']
    };
    const now = new Date();
    const m = now.getMonth() + 1;
    const list = SEASONAL_BY_MONTH[m] || [];
  ...
  function setNearbyInfo(){
    ...
    if(state.nearby && state.nearby.ready && state.nearby.presentCats && state.nearby.presentCats.length){
      ...
      els.nearbyInfo.textContent = '';
    }
  }

  function updateResultUI(name){
    els.result.textContent = name || '';
    els.resultSection.hidden = !name;
  }

  // Logic
  function matchesSituation(it, selected){
    if(!selected || selected.length === 0) return true;
    const name = it.name; const cat = it.cat;
    const checks = {
      ...
      spicy: () => /매운|짬뽕|마라|김치|제육|낙지|떡볶이|부대|쭈꾸미/.test(name),
  ...
  function pickRandom(){
    const base = state.items.filter(it => state.selectedCats.has(it.cat));
    if(base.length === 0) return null;
    const filtered = base.filter(it => it.name !== state.lastPick && matchesSituation(it, state.context.situation));
    let list = filtered.length ? filtered : base.filter(it => matchesSituation(it, state.context.situation));
    if(list.length === 0) return null;
    // Prefer categories detected nearby
    if(state.nearby && state.nearby.ready && Array.isArray(state.nearby.presentCats) && state.nearby.presentCats.length){
      const presentSet = new Set(state.nearby.presentCats);
      const preferred = list.filter(it => presentSet.has(it.cat));
  ...
  function chooseAndShow(){
    ...
    if(!name){
      const hasSituation = state.context.situation && state.context.situation.length > 0;
      updateResultUI(hasSituation ? '선택한 상황에 맞는 메뉴가 없어요' : '선택된 카테고리에 메뉴가 없어요');
      return;
    }
    state.lastPick = name;
    saveState();
  ...
  // Weather + Nearby
  function catCuisineMap(){
    return {
      korean: ['korean','korea'],
      japanese: ['japanese','sushi','ramen','udon'],
      chinese: ['chinese'],
      western: ['italian','french','steak_house','european','american'],
      noodle: ['noodle','ramen','udon','soba'],
      rice: [],
      salad: ['salad','healthy'],
      sandwich: ['sandwich','bagel','deli'],
      fast: ['burger','pizza','fried_chicken'],
      vietnamese: ['vietnamese','pho','banh_mi'],
      thai: ['thai'],
      indian: ['indian','nepalese'],
      mexican: ['mexican','tacos','burrito'],
      brunch: ['breakfast','brunch','cafe'],
      med: ['mediterranean','turkish','greek','middle_eastern','kebab','shawarma'],
      seasia: ['indonesian','malaysian','singaporean'],
      dessert: ['ice_cream','cake','waffle','dessert','bakery'],
      drink: ['coffee_shop','cafe','tea','bubble_tea'],
      etc: []
    };
  }

  async function initNearbyPresence(lat, lng, radius = 1200){
    try{
      ...
      for(const u of urls){
        try{
          const res = await fetch(u + '?data=' + encodeURIComponent(base));
          if(res.ok){ data = await res.json(); ok = true; break; }
          lastErr = new Error('overpass http '+res.status);
        }catch(e){ lastErr = e; }
      }
      if(!ok) throw lastErr || new Error('overpass failed');

      const cuisines = new Set();
      if(Array.isArray(data.elements)){
        for(const el of data.elements){
          const t = el.tags || {};
          const c = (t.cuisine || '').toString().toLowerCase();
          if(!c) continue;
          c.split(';').map(s=>s.trim()).filter(Boolean).forEach(v=>cuisines.add(v));
        }
      }
      const map = catCuisineMap();
      const presentCats = Object.keys(map).filter(cat => map[cat].some(tag => cuisines.has(tag)));
      state.nearby = { ready:true, presentCats, radius, ts: Date.now(), lat, lng };
      saveState();
      setNearbyInfo();
    }catch(e){
      state.nearby = { ready:false, presentCats: [], radius, ts: Date.now(), lat, lng };
      saveState();
      setNearbyInfo();
    }
  }
  ...
  async function initWeather(){
    try{
      ...
      state.location = { lat, lng, ts: Date.now() };
      saveState();
      initNearbyPresence(lat, lng).catch(()=>{});
  ...
  function mapWeather(code, temp){
    let cond = '알 수 없음'; let emoji = '🌤️';
    const c = Number(code);
    if(c === 0){ cond='맑음'; emoji='☀️'; }
    else if([1,2,3].includes(c)){ cond='구름 조금'; emoji='⛅'; }
    else if([45,48].includes(c)){ cond='안개'; emoji='🌫️'; }
    else if([51,53,55,56,57].includes(c)){ cond='이슬비'; emoji='🌦️'; }
    else if([61,63,65,66,67,80,81,82].includes(c)){ cond='비'; emoji='🌧️'; }
    else if([71,73,75,77,85,86].includes(c)){ cond='눈'; emoji='❄️'; }
    else if([95,96,97].includes(c)){ cond='뇌우'; emoji='⛈️'; }
    const t = (temp!=null && Number.isFinite(temp)) ? `${Math.round(temp)}°C` : '';
    const text = t ? `${cond} · ${t}` : cond;
    return { text, emoji };
  }

  // Events
  els.resetFilters.addEventListener('click', () => {
    if(state.selectedCats.size === state.categories.length) state.selectedCats.clear();
    else state.selectedCats = new Set(state.categories.map(c=>c.id));
    saveState();
    renderCategories();
  });
  els.randomBtn.addEventListener('click', chooseAndShow);
  if(els.clearContextBtn){
